	...
	var ms = {
		...
		fillHtml:function(obj,args){
			return (function(){
				obj.empty();
				//上一页
					obj.append('<li><a class="firstPage" href="javascript:;">首页</a></li>');
				if(args.current > 1){
					obj.append('<li><a href="javascript:;" class="prevPage">上一页</a></li>');
				}else{
					obj.remove('.prevPage');
					obj.append('<li><a class="disabled" href="javascript:;">上一页</a></li>');
				}
				//中间页码
				...
				for (;start <= end; start++) {
					if(start <= args.pageCount && start >= 1){
						if(start != args.current){
							...
							obj.append('<li class="thisclass">'+ start +'</li>');
						}
					}
				}
				...
				obj.append('<li><span class="pageinfo">共 <strong>3</strong>页 <strong>3</strong>条 </span></li>');
			})();
		},
		//绑定事件
		bindEvent:function(obj,args){
			return (function(){
				...
				obj.on("click","a.prevPage",function(){
					...
					var current = parseInt(obj.children("li.thisclass").text());
